  ...
  html2canvas(contenedor).then(canvas => {
    ...
    canvas.toBlob(blob => {
      ...
      if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
        guardarBtn.textContent = "1️⃣  Toca y mantén para guardar";
        guardarBtn.removeAttribute("download");
      } else {
        guardarBtn.textContent = "1️⃣ Guardar imagen";
        guardarBtn.setAttribute("download", "carton_" + currentCardId + ".png");
      }
